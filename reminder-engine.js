  ...
  /* [REBUILD FIX] The due-reminder modal markup was mangled by the decompiler
    ...
    function showDueReminder(r) {
      ...
      function deleteReminder(id) {
        ...
        F().reminders = F().reminders.filter(x => x.id !== id);
        save();
