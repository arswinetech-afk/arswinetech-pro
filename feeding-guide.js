...
(function () {
  ...
  function saveBatchConsumption(batchId, btn) {
    ...
    F().feedPlan = p;
    save(); renderAll(); toast(batchId + ' consumption updated');
  }
