...
(function () {
  ...
  function saveFeedDelivery(ev) {
    ...
    if (row) { row.bags = round2((+row.bags || 0) + n); row.price = +o.price_bag || row.price; }
    else { F().feed.push({ type: o.feed_type, bags: n, price: +o.price_bag || 0 }); }
  ...
  function openFeedReport() {
    ...
    document.body.insertAdjacentHTML('beforeend', `<div class="drill-bg" id="feedReport"><article class="certificate">
