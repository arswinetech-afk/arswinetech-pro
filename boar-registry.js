...
(function () {
  ...
  function registryPanelHTML() {
    ...
    if (!all.length) {
      ...
      rows = all.map(b => `<div class="summary-row" data-boar-row>` +
  ...
  Object.assign(window, { openBoarEditor, saveBoar, toggleBoarStatus, deleteBoar });
